...
public class OrderMedicineAdapter extends RecyclerView.Adapter<MedicineAdapter.ViewHolder>{

    private ArrayList<OrderMedicineModel> listdata;
    private OrderDetailScreen context;


    // RecyclerView recyclerView;
    public  OrderMedicineAdapter(ArrayList<OrderMedicineModel> listdata, OrderDetailScreen medicinesList) {
    ...
    public void onBindViewHolder(MedicineAdapter.ViewHolder holder, int position) {
        final OrderMedicineModel ListData = listdata.get(position);
        ...
        holder.oldPrice.setText((Html.fromHtml("<strike>" + "Rs "+ListData.getOriginalPrice() + "</strike>")));
